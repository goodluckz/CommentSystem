...
(function($) {
  ...
  function makeupBalloon($target, $balloon, options) {
    ...
    function makeTip(balloon, tip, m, tipSize, color) {
      ...
      tip.inactive()["setBorder" + m.camel.pos.f](tipSize)["setBorder" + m.camel.pos.c1](len)["setBorder" + m.camel.pos.c2](len)["set" + m.camel.pos.p1]((m.isTopLeft) ? -tipSize : balloon.inner[m.size.p])["set" + m.camel.pos.c1](balloon.inner[m.size.c] / 2 - len)
        .active()
